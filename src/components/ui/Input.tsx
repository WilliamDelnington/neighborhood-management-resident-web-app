...
const inputClass =
    "w-full rounded-xl border border-ng_20 bg-white px-3 py-3 text-[15px] text-text_1 placeholder:text-text_3 transition-colors focus:outline-none focus:border-primary-400 focus:bg-white focus:ring-2 focus:ring-primary-100";
